...
export class ProductTemplateAttributeLine extends Component {
    static template = "oxProductConfigure.ptal";
    static props = {
    ...
    getPTAVTemplate() {
        switch(this.props.attribute.display_type) {
            case 'color':
                return 'oxProductConfigure.ptav-color';
            case 'multi':
                return 'oxProductConfigure.ptav-multi';
            case 'pills':
                return 'oxProductConfigure.ptav-pills';
            case 'radio':
                return 'oxProductConfigure.ptav-radio';
            case 'select':
                return 'oxProductConfigure.ptav-select';
        }
    }
