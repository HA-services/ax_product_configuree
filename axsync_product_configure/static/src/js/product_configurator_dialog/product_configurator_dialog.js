...
export class OxProductConfigureDialog extends Component {
    static components = { Dialog, PurchaseProductList};
    static template = 'axsync_product_configure.dialog';
    static props = {
    ...
    */
    async _loadData(onlyMainProduct) {
        return rpc('/axsync_product_configure/get_values', {
    ...
    async _createProduct(product) {
        return rpc('/axsync_product_configure/create_product', {
    ...
    async _updateCombination(product, quantity) {
        return rpc('/axsync_product_configure/update_combination', {
            product_template_id: product.product_tmpl_id,
            combination: this._getCombination(product),
            currency_id: this.props.currencyId,
            quantity: quantity,
    ...
    async _getOptionalProducts(product) {
        return rpc('/axsync_product_configure/get_optional_products', {
            product_template_id: product.product_tmpl_id,
            combination: this._getCombination(product),
    ...
    /**
     * Return the total message with formatted currency.
     */
    get totalMessage() {
    ...
    /**
     * Return the total of all products, formatted in currency.
     */
    getFormattedTotal() {
